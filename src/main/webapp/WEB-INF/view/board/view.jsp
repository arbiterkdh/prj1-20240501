...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            <h3 class="mb-5">${board.id} 번 게시물</h3>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea style="resize: none" id="textareaContent" class="form-control" cols="30" rows="10"
            ...
            <sec:authorize access="isAuthenticated()">
                ...
                <c:if test="${member.id eq board.memberId or isAdmin}">
                    <div class="mb-3">
